...
func price(rentalCar: RentalCar, totalHours: Int) -> Float {
    ...
    return Float(days) * dailyPrice + Float(hours) * hourlyPrice // this return statement isn't quite right yet!
}
...
class GCDTestSuite: XCTestCase {
    ...
    func testPriceMazda98() {
        let expectedResult: Float = 59.99 //changed according to direction on white board
